...
ns.constants = {
  ...
  HEALTH_LOG_INTERVAL_MS: 15_000,
  BUFFER_RUNWAY_EMERGENCY_SEC: 5,
  BUFFER_RUNWAY_AGGRESSIVE_SEC: 15,
  BUFFER_RUNWAY_NORMAL_SEC: 30,
  BUFFER_RUNWAY_MAINTENANCE_SEC: 300,
  BUFFER_TARGET_RUNWAY_SEC: 300,
  PANIC_TARGET_RUNWAY_SEC: 450,
  ...
  RESCUE_EXIT_RUNWAY_SEC: 8,
  RESCUE_ENTER_HEALTH_PCT: 5,
  RESCUE_EXIT_HEALTH_PCT: 25,
  RESCUE_GENERATION_BUMP_MIN_MS: 800,
  RESCUE_SEGMENTS_AHEAD: 2,
  /** Scoped rescue abort: protect in-flight fetches this far behind/ahead of the playhead. */
  RESCUE_KEEP_BEHIND_SEGMENTS: 2,
  RESCUE_KEEP_AHEAD_SEGMENTS: 8,
  /** Anchor reconciliation: promote predictor when it diverges from the committed anchor. */
  ANCHOR_RECONCILE_DIVERGENCE_SEGMENTS: 3,
  ANCHOR_RECONCILE_DWELL_MS: 500,
  ANCHOR_RECONCILE_MIN_INTERVAL_MS: 800,
  /** How long predictor / observed-segment / velocity signals stay usable for reconciliation. */
  ANCHOR_SIGNAL_FRESH_MS: 3_000,
  /** Byte-aware scheduling: this many playhead-nearest segments keep strict playback order. */
  BYTE_AWARE_HEAD_SEGMENTS: 3,
  ...
  BUFFER_RUNWAY_COMFORT_SEC: 120,
  BUFFER_RUNWAY_IDLE_SEC: 300,
